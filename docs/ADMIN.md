...
| --vault-approle-secret-name                           | VAULTAPPROLESECRETNAME         |                          | Secret name in k8s namespace with approle credentials. Used with Vault approle authentication. Secret should contain 'role_id' and 'secret_id' keys.                                                                               |
| --vault-approle-secret-namespace                      | VAULTAPPROLESECRETNAMESPACE    |                          | Namespace name for the secret with approle credentials.                                                                                                                                                                            |
