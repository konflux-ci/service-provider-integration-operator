...
| spec.secret.type                           | enum              | The type of the secret created as specified by Kubernetes (e.g. “Opaque”, “kubernetes.io/basic-auth”, …) If type is not defined or is "Opaque" data is written to the "token" field.|                      | false     |
