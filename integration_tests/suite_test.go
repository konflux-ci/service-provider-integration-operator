...
var _ = BeforeSuite(func() {
	...
	ITest.Capabilities.DownloadFileImpl = func(_ context.Context, request *api.SPIFileContentRequest, credentials serviceprovider.Credentials, i int) (string, error) {
		return "abcdefg", nil
	}
