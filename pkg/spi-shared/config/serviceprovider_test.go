			...
			Items: []v1.Secret{
				{
					ObjectMeta: metav1.ObjectMeta{
						...
						Labels: map[string]string{
							v1beta1.ServiceProviderTypeLabel: string(ServiceProviderTypeGitHub),
						},
					},
				},
			},
			...
			Items: []v1.Secret{
				{
					ObjectMeta: metav1.ObjectMeta{
						...
						Namespace: secretNamespace,
						Labels: map[string]string{
							v1beta1.ServiceProviderTypeLabel: string(ServiceProviderTypeQuay),
						},
					},
				},
			},
...
func TestMultipleProviders(t *testing.T) {
	...
	test := func(t *testing.T, oauthConfigSecrets []v1.Secret, shouldFind bool, findSecretName string, shouldError bool) {
		...
		found, secret, err := FindServiceProviderConfigSecret(ctx, cl, secretNamespace, "blabol.eh", ServiceProviderTypeGitHub)
