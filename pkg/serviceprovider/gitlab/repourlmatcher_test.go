...
func TestParseOwnerAndProjectFromUrl(t *testing.T) {
	...
	testSuccess(t, "https://personal.gitlab.com/foo-user/foo-project/foo-subproject1.git", "foo-user", "foo-project")
	testSuccess(t, "https://personal.gitlab.com/foo-user/foo-project/foo-subproject1/foo-subproject2", "foo-user", "foo-project")
	testSuccess(t, "https://personal.gitlab.com/foo-user/foo-project/foo-subproject1/foo-subproject2.git", "foo-user", "foo-project")
