...
func TestMetricResponseTime(t *testing.T) {
	reg := prometheus.NewRegistry()
	...
	count, err := prometheusTest.GatherAndCount(reg, "redhat_appstudio_spi_oauth_service_requests_total", "redhat_appstudio_spi_oauth_service_response_time_seconds")
