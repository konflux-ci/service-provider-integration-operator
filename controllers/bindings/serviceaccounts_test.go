...
func TestServiceAccountSync(t *testing.T) {
	...
	t.Run("with SA", func(t *testing.T) {
		...
		objectMarker.MarkReferencedImpl = func(ctx context.Context, o client.Object) (bool, error) {
	...
	t.Run("no SA", func(t *testing.T) {
		...
		objectMarker.MarkManagedImpl = func(ctx context.Context, o client.Object) (bool, error) {
			if o.GetLabels() == nil {
	...
	t.Run("flip referenced to managed", func(t *testing.T) {
		...
		objectMarker.IsReferencedImpl = func(ctx context.Context, o client.Object) (bool, error) {
	...
	t.Run("flip managed to referenced", func(t *testing.T) {
		...
		objectMarker.UnmarkManagedImpl = func(ctx context.Context, o client.Object) (bool, error) {
	...
	t.Run("single owner, multiple referenced", func(t *testing.T) {
		...
		objectMarker.MarkManagedImpl = func(ctx context.Context, o client.Object) (bool, error) {
			objectMarker.MarkReferenced(ctx, o)
			if o.GetLabels() == nil {
				o.SetLabels(map[string]string{})
			}
			o.GetLabels()["gelinkt_managed"] = "yay"
