...
func main() {
	...
	if err = (&controllers.ServiceProviderIntergrationOperatorConfigurationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ServiceProviderIntergrationOperatorConfiguration")
		os.Exit(1)
	}
